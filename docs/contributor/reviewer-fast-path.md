...
1. Confirm the project is still Alpha and that the preferred public evaluation path is Linux nightly, with a public Windows binary path available through Releases/nightlies.
...
- [Try in 5 Minutes](../getting-started/try-in-5-minutes.md) for the fastest nightly-first evaluation loop, or use the public Windows binary path from Releases/nightlies.
