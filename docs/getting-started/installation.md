...
| --- | --- | --- |
| Reuse a public or local editor | You already have a Linux nightly, a Windows public binary from Releases/nightlies, or a binary you built locally. | [Public Evaluator](quick-start.md) |
